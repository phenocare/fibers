---
title: "fibers - C2 - URI & PLA - no comment - v0.2.0"
author: "Your Name"
date: "The Date"
output: 
  html_document:
...
manifest$sampleMatrixType[manifest$sampleMatrixType == "URINE"] <- "URI"
...
manifest$sourceID <- sapply(manifest$tubeLabel, function(x) strsplit(x, "-")[[1]][1])
...
# 10x10 (Lettered) 
# as boxTypes.
manifest$boxName <- cleanNames(manifest$boxName) #rep(NA, N)
...
manifest$tubePosition <- numToPos(manifest$tubePosition, boxDim = c(10,10))
